...
public class EffectState : States
{
    public override void Enter()
    {
        ...
        // ORDER: Red, Blue, Green, Destroyer, Pakku, Spreading, +the rest
        var sortedTiles = GM.livingTiles
            .OrderBy(tile => tile.currentTileState == HexagonTile.TileStates.RedTile ? 0 :
                tile.currentTileState == HexagonTile.TileStates.BlueTile ? 1 :
                tile.currentTileState == HexagonTile.TileStates.GreenTile ? 2 :
                tile.currentTileState == HexagonTile.TileStates.DestroyerTile ? 3 :
